...
ASSERT_EQ(ATRACE_MESSAGE_LENGTH - 1,
lseek(atrace_marker_fd,
0, SEEK_CUR));
ASSERT_EQ(0,
lseek(atrace_marker_fd,
...
EXPECT_EQ(ATRACE_MESSAGE_LENGTH - 1,
lseek(atrace_marker_fd,
0, SEEK_CUR));
ASSERT_EQ(0,
lseek(atrace_marker_fd,
...
expected += android::base::StringPrintf("%.*s", expected_len, name.
...
expected += android::base::StringPrintf("%.*s|12345", expected_len, name.
...
expected += android::base::StringPrintf("%.*s|17179869183", expected_len, name.
